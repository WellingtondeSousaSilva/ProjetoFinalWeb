...
<body>
    ...
    <h1 style="font-family: 'Baskervville', serif; color: #2b154a; position: absolute; left: 430px;"><i class="fas fa-shopping-cart"></i>Comprar</h1>
    ...
    <div id="tabela">
        ...
        <table style="position: absolute; left: 30px;">
            ...
            <tr>
                ...
                <td><?=$valor?></td>
                <td><?=$quanProduto?></td>
                <td><a href="saidaProduto.php?id=<?php echo $id?>">comprar</a></td>
